...
def main():
    parser = argparse.ArgumentParser(
        description="Wobbly Rosenbrock: nominal vs CVaR-optimized comparison"
    )
    parser.add_argument(
        "--mode",
        choices=["compare", "nominal", "cvar"],
        default="compare",
    ...
    parser.add_argument(
        ...
        type=int,
        default=5000,
        help="Number of scenarios for evaluation (oos CVaR).",
    )
    parser.add_argument(
        "--sigma-a",
        type=float,
        default=0.05,
        dest="sigma_a",
        help="Std-dev of noise in 'a'.",
    )
    parser.add_argument("--a", type=float, default=1.0, help="Nominal parameter a.")
    parser.add_argument(
        "--b", type=float, default=100.0, help="Rosenbrock parameter b>0."
    )
